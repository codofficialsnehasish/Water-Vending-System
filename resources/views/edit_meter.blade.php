                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/updatemeter')}}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$data->id}}">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="meter">Meter</label>
                                                        <input type="text" class="form-control" value="{{$data->name}}" name="meter" id="meter" placeholder="Enter meter" required>
                                                    </div>
                                                    <div class="mb-0">
                                                        <div>
