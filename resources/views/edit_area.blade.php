                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Edit Area</h6>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-12">
                                        <div class="card">
                                            <div class="card-header bg-primary text-light">Edit the Area</div>
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/updatearea')}}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$data->id}}">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="area">Area</label>
                                                        <input type="text" class="form-control" name="area" value="{{$data->area_name}}" id="area" placeholder="Enter area" required>
                                                    </div>
                                                    <div class="mb-0">
                                                        <div>
