...
class Admin extends Controller
{
    ...
    public function edited_bill(Request $r){
        ...
        $obj->current_bill = $r->currb;
        $obj->previous_bill = $r->prevb;
    ...
    public function fromto(Request $r){
        ...
        //     ->whereBetween('date', [$date1, $date2])
        //     ->get(["expences.*","expence_catagory.catagory as cata"]);
        // $data = Expences::whereBetween('date', [$date1, $date2])->get();
        // $data = Expences::all();
        // return redirect(url('/reports'))->with(['data'=>$data]);
        // self::generate_report($date1,$date2);
        // return view('reports')->with(['data'=>$data]);
    }
    ...
    public function put_balance(Request $r){
        $id = $r->id;
        // $obj = Bill::find($id);
        $obj['obj'] = Bill::where("id","=",$id)->get("balance");
